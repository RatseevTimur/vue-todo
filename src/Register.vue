    ...
    <article class="container">
      ...
      <div class="block">
        ...
        <section class="block_itemr block-item" v-bind:class="{ active: registActive }">
          ...
          <button class="block-item_btn signup-btn"
                  @click="welcome">Зарегистрироваться
          </button>
        </section>
      ...
      <div class="form-box" v-bind:class="{ active: registActive }">
        ...
        <form class="form form_signin"
          ...
          <p>
            <button type="submit"
                    class="form_btn" @click="login()">Войти
            </button>
          </p>
          <p>
        ...
        <div class="form form_signup">
          ...
          <p>
            <input type="text" v-model="name" class="form_input" placeholder="Имя">
          </p>
          <p>
            <input type="email" v-model="email" class="form_input" placeholder="Почта">
          </p>
          <input type="number" v-model="age" class="form_input" placeholder="Возраст"/>
          <p>
            <input type="password" v-model="password" class="form_input" placeholder="Введите пароль">
          </p>
          <p>
            <button
                :disabled="!email || !password"
                class="form_btn form_btn_signup"
                @click="(e) => onRegisterButtonClick(e)">
              Зарегистрироваться
            </button>
          </p>
        </div>
...
export default {
  ...
  methods: {
    onRegisterButtonClick: async function () {
      try {
        ...
        alert('Ошибка Сервера, попробуйте зайти позже!');
      }
    },
    login: function () {
